...
public class BlueLeft extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        mainRobot.shooter.setpoint = 830;
            ...
            switch(stackHeight) {
                ...
                case 0:
                    ...
                    dropWobble = mainRobot.drive.trajectoryBuilder(initPose)
                            .back(60)
                            .splineToConstantHeading(new Vector2d(60, 8), 0)
                            .build();

                    prepToShoot = mainRobot.drive.trajectoryBuilder(dropWobble.end())
                            .lineToLinearHeading(new Pose2d(64,-19,0))
                            .build();
                ...
                case 1:
                    ...
                    dropWobble = mainRobot.drive.trajectoryBuilder(initPose)
                            .back(60)
                            .splineToConstantHeading(new Vector2d(84,-18), Math.toRadians(180))
                            .build();
